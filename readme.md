![PROOF](https://github.com/devilsadvocate101/SENTINEL/blob/main/proof/0226.gif)
...
5. **Paste & Run Script**:
   - Copy all the code in [**SENTINEL_V1.2.js**](https://github.com/devilsadvocate101/SENTINEL/blob/main/SENTINEL_V1.2.js).
